                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr className="cart_item">
                                                    ...
                                                    36 Hr Survival Candle In Tin - Survival Equipment <strong className="product-quantity"> × 1</strong>
                                                    </td>
                                                ...
                                                <tr className="cart_item">
                                                    <td className="product-name">
                                                    Cardiac Science Intellisense® Battery, Powerheart G5 - Cardiac Science, Batteries <strong className="product-quantity"> ×
                                                            1</strong>
                                                    </td>
                                                    <td className="product-total">
                                                ...
                                                <tr className="cart_item">
                                                    <td className="product-name">
                                                    Alcohol Swabs, 200/Box, 4/Pack - Infection Control	 <strong className="product-quantity"> ×
                                                            1</strong>
                                                    </td>
                                                    <td className="product-total">
