...
const HeroSectionTwo = () => {
    return (
        <div className="test hero-area hero-height d-flex align-items-center position-relative justify-content-center">
            ...
            <div className="container">
                <div className="hero-2-content-wrpapper position-relative">
                    ...
                    {/* <div className="hero-thumb-02 d-none d-lg-block">
                        <img src="assets/img/slider/hero-02.svg" alt="shape"/>
                    </div> */}
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-8 col-md-10">
                            <div className="slider-content-wrapper">
                                <div className="hero-tittle-info text-center mb-45">
                                    <h2>Be that hand that helps.<br/>
                                        Get your training today.</h2>
                                </div>
                                ...
                                <div className="slider-course-content text-center">
                                    <ul>
                                        <li><i className="fas fa-check-circle"></i><span>Standard First Aid (SFA) standards
                                            </span></li>
                                        <li><i className="fas fa-check-circle"></i><span>Official certificate</span></li>
                                        <li><i className="fas fa-check-circle"></i><span>Online and in-class offerings</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
