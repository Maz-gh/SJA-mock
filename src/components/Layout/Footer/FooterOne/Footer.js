                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                <div className="footer-widget f-w1 mb-40">
                                    ...
                                    <Link href="/"><a><img src="assets/img/logo/footer-inv.png" alt="footer-logo"/></a></Link>
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <p>Charitable Organization Number: <strong>10802 2237 RR0001</strong></p>
                                    </div>
                                </div>
                                <div className="col-xl-4 col-lg-4 col-sm-6">
                                    <div className="copy-right-support border-line-2">
                                                ...
                                                <g id="headphones" transform="translate(-31)">
                                                    ...
                                                    <g id="Group_2170" data-name="Group 2170">
                                                        <path id="Path_2983" data-name="Path 2983"
                                                            ...
                                                            transform="translate(-91 -210)" fill="#006633" />
                                                    </g>
                                                    </g>
                                                    ...
                                                    <g id="Group_2172" data-name="Group 2172">
                                                        <path id="Path_2984" data-name="Path 2984"
                                                            ...
                                                            transform="translate(-31 -242.366)" fill="#006633" />
                                                    </g>
                                                    </g>
                                                    ...
                                                    <g id="Group_2174" data-name="Group 2174">
                                                        <path id="Path_2985" data-name="Path 2985"
                                                            ...
                                                            transform="translate(-211 -210)" fill="#006633" />
                                                    </g>
                                                    </g>
                                                    ...
                                                    <g id="Group_2176" data-name="Group 2176">
                                                        <path id="Path_2986" data-name="Path 2986"
                                                            ...
                                                            transform="translate(-449.722 -242.366)" fill="#006633" />
                                                    </g>
                                                    </g>
                                                    ...
                                                    <g id="Group_2178" data-name="Group 2178">
                                                        <path id="Path_2987" data-name="Path 2987"
                                                            ...
                                                            transform="translate(-31)" fill="#006633" />
                                                    </g>
                                                    </g>
                                                </g>
                                            </svg>
                                        ...
                                        <div className="copyright-svg-content">
                                            ...
                                            <h5><a href="tel:(987)547587587">1-800-268-7581</a></h5>
                                        </div>
                                    </div>
                                </div>
