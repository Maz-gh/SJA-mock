                    ...
                    <ul>
                        <li>
                            ...
                            <div className="cartmini__content">
                                <h5><a href="#">Eyewash with Eye Cup, 1L - Eyewash</a></h5>
                        ...
                        <li>
                            ...
                            <div className="cartmini__content">
                                <h5><a href="#">36 Hr Survival Candle In Tin - Survival Equipment</a></h5>
                                <div className="product-quantity mt-10 mb-10">
                        ...
                        <li>
                            ...
                            <div className="cartmini__content">
                                <h5><a href="#">Alcohol Swabs, 200/Box, 4/Pack - Infection Control</a></h5>
                                <div className="product-quantity mt-10 mb-10">
