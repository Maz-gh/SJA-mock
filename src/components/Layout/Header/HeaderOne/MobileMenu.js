        ...
        <div className={menuOpen ? "side-info info-open": "side-info"}>
            ...
            <div className="offset-widget offset-logo mb-40">
                <div className="row align-items-center">
                    <div className="col-9">
                        <Link href="/"><a><img className="logo-side" src="assets/img/logo/sja-icon.png" alt="Logo"/></a></Link>
                    </div>
            ...
            <div className="offset-widget offset_menu-top mb-20">
                    <div className="header-menu-top-icon mb-20">
                        <a href="#"><i className="fas fa-phone"></i>1-800-268-7581</a>
                        <a href="#"><i className="fal fa-envelope"></i>info.on@sja.ca</a>
                        <a href="#"><i className="fal fa-map-marker-alt"></i>Ontario</a>
                    </div>
                </div>
